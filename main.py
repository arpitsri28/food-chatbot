...
def remove_from_order(parameters: dict, session_id: str):
  if session_id not in inprogress_orders:
    return JSONResponse(content={
      "fulfillmentText": "I'm having some trouble finding your oder. Sorry! Can you place a new order?"
    })
...
def complete_order(parameters:dict, session_id:str):
  if session_id not in inprogress_orders:
    fulfillment_text = "I'm having some trouble finding your oder. Sorry! Can you place a new order?"
  else:
